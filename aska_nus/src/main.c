...
void ble_write_thread(void)
{
	...
	for (;;) {
		...
		struct uart_data_t *buf = k_fifo_get(&fifo_uart_rx_data,
							 ...
							 /* SAULS CODE REMOVED START HERE
							 // This code was removed so that any data coming from the uart is immediately
							 // sent through ble
